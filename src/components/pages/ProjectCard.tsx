  ...
  return (
    ...
    >
      <MagicCard gradientColor={theme === "dark" ? "#262626" : "#D9D9D955"}>
        {/* Hover overlay */}
        <div
          className="absolute inset-0 bg-black bg-opacity-70 cursor-pointer flex flex-col justify-center items-center p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          aria-hidden="true"
        >
