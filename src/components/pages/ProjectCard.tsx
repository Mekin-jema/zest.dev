...
const ProjectCard= ({ project }:ProjectCardProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-black bg-opacity-70 cursor-pointer flex flex-col justify-center items-center p-2 opacity-0 hover:opacity-100 transition-opacity duration-300">
   
        <h3 className="text-xl font-bold text-white mb-2">{project.title}</h3>
        <p className="text-gray-300 text-sm mb-4 text-start">
          {project.description}
        </p>
